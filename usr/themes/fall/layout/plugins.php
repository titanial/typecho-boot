<?php if(wap()) { ?> <!-- wap底部版权 -->
    <ul class="list_style" style="font-size: .75rem;
        ...
        <li>&copy; <?php echo date('Y'); ?> <a style="color: rgb(159, 159, 159);" href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a>.<?php _e('由 <a style="color: rgb(159, 159, 159);" href="http://www.typecho.org">Typecho</a> 强力驱动'); ?>.当前使用<a style="color: rgb(159, 159, 159);" href="//ouyu.me"><?php echo _Themes();?>主题</a>.访客总人数：<?php echo theAllViews();?></li>
    </ul>
    <ul class="list_style" style="font-size: .75rem;
                                    padding:  5px 1.5rem;
                                    color: rgb(159, 159, 159);">
