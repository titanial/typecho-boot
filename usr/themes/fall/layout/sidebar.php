...
<aside class="right_container px-5 py-5">
    ...
    <section class="Info_aside__item">
        ...
        <ul class="list_style">
            ...
            <li>&copy; <?php echo date('Y'); ?> <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a>.<?php _e('由 <a href="http://www.typecho.org">Typecho</a> 强力驱动'); ?>.当前使用<a href="//ouyu.me"><?php echo _Themes();?>主题</a>.访客总人数：<?php echo theAllViews();?></li>
        </ul>
